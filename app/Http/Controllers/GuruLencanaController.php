...
class GuruLencanaController extends Controller
{
    public function index()
    {
        $badges = Badge::with(['quiz', 'surat', 'juz'])->orderBy('created_at', 'desc')->get();
        return view('guru.lencana.index', compact('badges'));
    }
    ...
    public function create()
    {
        ...
        return view('guru.lencana.create', compact('quizzes', 'surats', 'juzs'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // login_streak & leaderboard_rank ditambahkan untuk mendukung
            // lencana "Semangat 3 Hari", "Konsisten 7 Hari", "Istiqamah 14 Hari",
            // "Bintang Istiqamah", dan "Raja Quiz".
            'criteria_type' => 'required|in:poin,quiz_selesai,nilai_sempurna,hafalan,juz_selesai,login_streak,leaderboard_rank',
        ...
        return redirect()->route('guru.lencana.index')
    ...
    public function edit($id)
    {
        ...
        return view('guru.lencana.edit', compact('badge', 'quizzes', 'surats', 'juzs'));
    }
