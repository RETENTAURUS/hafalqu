...
@section('content')
  ...
  @else
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div class="bg-white rounded-xl border border-slate-200 border-t-4 {{ $levelBorder[$badge->level] ?? 'border-t-slate-200' }} p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-3">
            <x-badge-icon :badge="$badge" size="w-14 h-14" />
            <div>
