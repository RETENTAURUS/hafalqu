...
<style>
  ...
  /* Kustomisasi Scrollbar Modal Internal agar Terlihat Lebih Bersih */
...
<div id="tambahSurahModal"
  ...
  <div class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden max-h-[85vh] flex flex-col">
    ...
    <form action="{{ route('guru.soal.storeSurat', $juz->id) }}" method="POST" class="flex flex-col flex-1 overflow-hidden">
      @csrf
      <div class="px-6 py-5 space-y-4 overflow-y-auto flex-1 custom-modal-scrollbar">
...
<div id="pilihJenisSoalModal"
  ...
  <div class="bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
    ...
    <div class="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto flex-1 custom-modal-scrollbar">
...
<div id="tambahSoalModal"
     class="hidden fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 modal-backdrop"
     style="backdrop-filter:blur(2px)">
  <div class="bg-white w-full max-w-lg rounded-2xl shadow-xl overflow-hidden max-h-[85vh] flex flex-col">
    <div class="px-6 pt-5 pb-4 border-b border-slate-100 flex items-center justify-between flex-shrink-0">
      <div>
    ...
    <form action="{{ route('guru.soal.storeSoal') }}" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 overflow-hidden">
      ...
      <div class="px-6 py-5 space-y-4 overflow-y-auto flex-1 custom-modal-scrollbar max-h-[55vh]">
        <div>
        ...
        <div id="audioUploadSection" class="hidden bg-slate-50 p-3 rounded-xl border border-slate-100">
      ...
      <div class="px-6 pb-5 flex justify-end gap-2 border-t border-slate-100 pt-4 flex-shrink-0 bg-white z-10">
...
<div id="modalDetail"
  ...
  <div class="bg-white w-full max-w-lg rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
    ...
    <div class="px-6 pb-5 flex justify-end border-t border-slate-100 pt-4 flex-shrink-0">
      <button onclick="document.getElementById('modalDetail').classList.add('hidden')"
  ...
  <div class="bg-white w-full max-w-lg rounded-2xl shadow-xl overflow-hidden max-h-[85vh] flex flex-col">
    ...
    <form id="form-edit" method="POST" enctype="multipart/form-data" class="flex flex-col flex-1 overflow-hidden">
      ...
      <div class="px-6 py-5 space-y-4 overflow-y-auto flex-1 custom-modal-scrollbar max-h-[55vh]">
        ...
        <div id="edit-audio-wrap" class="hidden bg-slate-50 p-3 rounded-xl border border-slate-100">
          ...
          <p id="edit-audio-current" class="text-[11px] text-teal-600 mt-1 hidden font-medium truncate"></p>
        </div>
